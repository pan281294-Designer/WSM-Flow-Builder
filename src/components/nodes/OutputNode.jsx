...
export default function OutputNode({ data, selected }) {
  return (
    <div className={`px-4 py-2 shadow-md rounded-md bg-white dark:bg-zinc-800 border-2 ${selected ? 'border-red-500' : 'border-zinc-200 dark:border-zinc-700'} min-w-[150px]`}>
